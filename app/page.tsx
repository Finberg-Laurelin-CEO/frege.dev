      ...
      <main id="main" className="screen">
        ...
        <section id="privacy" aria-label="Privacy policy">
          ...
          <dl className="rows policy">
            <div><dt>what we collect</dt><dd>only what you type into the early-access form: name, work email, company, role, company size, expected users, current agent tools, monthly AI spend, decision timeline, and your main pain point. nothing else.</dd></div>
